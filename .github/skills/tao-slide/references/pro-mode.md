...
**ppt-master location**: `.github/skills/tao-slide/ppt-master/` (embedded trong repo này)
...
| Source | Command |
|--------|---------|
| PDF | `python3 .github/skills/tao-slide/ppt-master/scripts/source_to_md/pdf_to_md.py <file>` |
| DOCX | `python3 .github/skills/tao-slide/ppt-master/scripts/source_to_md/doc_to_md.py <file>` |
| PPTX | `python3 .github/skills/tao-slide/ppt-master/scripts/source_to_md/ppt_to_md.py <file>` |
| URL | `python3 .github/skills/tao-slide/ppt-master/scripts/source_to_md/web_to_md.py <URL>` |

## Step 2: Project Init

```bash
python3 .github/skills/tao-slide/ppt-master/scripts/project_manager.py init <name> --format ppt169
python3 .github/skills/tao-slide/ppt-master/scripts/project_manager.py import-sources <path> <files...> --move
```

## Step 3: Template Selection

```bash
cat .github/skills/tao-slide/ppt-master/templates/layouts/layouts_index.json
```
...
```
read_file .github/skills/tao-slide/ppt-master/references/strategist.md
read_file .github/skills/tao-slide/ppt-master/templates/design_spec_reference.md
```
...
```bash
python3 .github/skills/tao-slide/ppt-master/scripts/image_gen.py "prompt" --aspect_ratio 16:9 --image_size 1K -o <project_path>/images
```

## Step 6: Executor Phase

```
read_file .github/skills/tao-slide/ppt-master/references/executor-base.md
read_file .github/skills/tao-slide/ppt-master/references/executor-general.md  # hoặc consultant/consultant-top
```
...
Search: `ls .github/skills/tao-slide/ppt-master/templates/icons/chunk/ | grep <keyword>`

### Charts (50+)

```bash
cat .github/skills/tao-slide/ppt-master/templates/charts/charts_index.json
```
...
Chi tiết: `.github/skills/tao-slide/ppt-master/references/shared-standards.md`
...
```bash
# 7.1
python3 .github/skills/tao-slide/ppt-master/scripts/total_md_split.py <project_path>
# 7.2
python3 .github/skills/tao-slide/ppt-master/scripts/finalize_svg.py <project_path>
# 7.3
python3 .github/skills/tao-slide/ppt-master/scripts/svg_to_pptx.py <project_path> -s final
```
